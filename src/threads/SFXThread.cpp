        ...
        if(sfx != SFX_NONE) {
            switch(sfx) {
                case SFX_WALL_COLLISION:
                    ...
                    playSFX("assets/efectos/ColisionMuro.mp3");
                    break;
                case SFX_SELF_COLLISION:
                    std::cout << "[SFX] Colision con ella misma\n";
                    playSFX("assets/efectos/ColisionEllamisma.mp3");
                    break;
                case SFX_SNAKE_COLLISION:
                    std::cout << "[SFX] Colision entre las serpientes\n";
                    playSFX("assets/efectos/ColisionEntre2.mp3");
                    break;
                case SFX_EAT_FOOD:
                    std::cout << "[SFX] Comer\n";
                    playSFX("assets/efectos/Comer.mp3");
                    break;
                default:
                    break;
            }
